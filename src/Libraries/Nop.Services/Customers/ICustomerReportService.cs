...
public partial interface ICustomerReportService
{
    ...
    Task<List<GenderStatisticsModel>> GetGenderStatisticsAsync(DateTime? startDate, DateTime? endDate);

    Task<List<UsersStatisticsModel>> GetPeriodUserStatisticsAsync(DateTime? startDate, DateTime? endDate, string period = "");
