...
public partial class CustomerService : ICustomerService
{
    ...
    public virtual async Task<Customer> GetCustomerByVendorIdAsync(int vendorId)
    {
        ArgumentNullException.ThrowIfNull(vendorId);
        var customer = await _customerRepository.Table.Where(x => x.VendorId == vendorId).FirstOrDefaultAsync();
        return customer;
