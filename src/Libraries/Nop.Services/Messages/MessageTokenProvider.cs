...
public partial class MessageTokenProvider : IMessageTokenProvider
{
    ...
    public virtual async Task AddCustomerTokensAsync(IList<Token> tokens, Customer customer)
    {
        ...
        //var otp = await _emailVerificationCodeService.GetLatestCodeAsync(customer.Id);
        //if (otp != null)
        //    tokens.Add(new Token("VerificationCode", otp.Code));
        //event notification
        await _eventPublisher.EntityTokensAddedAsync(customer, tokens);
    }


    public virtual async Task AddCustomerTokensAsync(IList<Token> tokens, Customer customer, string code)
    {
        tokens.Add(new Token("Customer.Email", customer.Email));
        tokens.Add(new Token("Customer.Username", customer.Username));
        tokens.Add(new Token("Customer.FullName", await _customerService.GetCustomerFullNameAsync(customer)));
        ...
        //var otp = await _emailVerificationCodeService.GetLatestCodeAsync(customer.Id);
        //if (otp != null)
            tokens.Add(new Token("VerificationCode", code));
        //event notification
        await _eventPublisher.EntityTokensAddedAsync(customer, tokens);
    }
