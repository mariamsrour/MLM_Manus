...
public partial interface IWorkflowMessageService
{
    ...
    Task<IList<int>> SendAdStatusChangedNotificationAsync(Customer customer, Product ad, int languageId);
    Task<IList<int>> SendSubscriptionInvoiceCustomerNotificationAsync(
