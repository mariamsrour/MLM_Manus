...
public partial class ReturnRequest : BaseEntity
{
    ...
    /// Gets or sets the quantity returned to stock
    /// </summary>
    public int ReturnedToVendorStatusId { get; set; }
    ...
    public ReturnToVendorStatus ReturnToVendorStatus
    {
        get => (ReturnToVendorStatus)ReturnedToVendorStatusId;
        set => ReturnedToVendorStatusId = (int)value;
    }
}