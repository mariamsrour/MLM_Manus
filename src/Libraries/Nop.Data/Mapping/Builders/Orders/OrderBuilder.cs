...
public partial class OrderBuilder : NopEntityBuilder<Order>
{
    ...
    public override void MapEntity(CreateTableExpressionBuilder table)
    {
        table
            ...
            .WithColumn(nameof(Order.BankTransactionNumber)).AsString(int.MaxValue).Nullable()
            .WithColumn(nameof(Order.ZactaURL)).AsString(int.MaxValue).Nullable()
            .WithColumn(nameof(Order.ZactaID)).AsString(int.MaxValue).Nullable();
