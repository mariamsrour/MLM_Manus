...
public partial class CheckoutModelFactory : ICheckoutModelFactory
{
    ...
    public virtual async Task<CheckoutPaymentMethodModel> PreparePaymentMethodModelAsync(IList<ShoppingCartItem> cart, int filterByCountryId)
    {
        ...
        //{
        //    Name = "Wallet",
        //    PaymentMethodSystemName = "Wallet",
        //    Description = "Use Wallet Credit to pay for your order.",
        //    Fee = "0",
        //});
        ;
    ...
    /// </summary>
    /// <param name="cart">Cart</param>
    /// <param name="useWallet">Cart</param>
    /// <returns>
    /// A task that represents the asynchronous operation
    /// The task result contains the confirm order model
    /// </returns>
    public virtual async Task<CheckoutConfirmModel> PrepareConfirmOrderModelWithWalletAsync(IList<ShoppingCartItem> cart, bool useWallet)
    {
        var model = new CheckoutConfirmModel
        {
            //terms of service
