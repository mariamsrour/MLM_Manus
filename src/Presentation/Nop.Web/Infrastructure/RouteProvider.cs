...
public partial class RouteProvider : BaseRouteProvider, IRouteProvider
{
    ...
    public void RegisterRoutes(IEndpointRouteBuilder endpointRouteBuilder)
    {
        ...
        endpointRouteBuilder.MapControllerRoute(name: "CustomerWallet",
            pattern: $"{lang}/customer/wallet",
        ...
        endpointRouteBuilder.MapControllerRoute(name: "RealstateLiscence",
     pattern: $"{lang}/RealstateLiscence",
     defaults: new { controller = "PostAd", action = "RealstateLiscence" });



        endpointRouteBuilder.MapControllerRoute(name: "EditAd",
       pattern: $"{lang}/EditAd",
       defaults: new { controller = "PostAd", action = "EditAd" });
        ...
        endpointRouteBuilder.MapControllerRoute(name: "CustomerAds",
       pattern: $"{lang}/Customer-Ads",
       defaults: new { controller = "Catalog", action = "MyAds" });


        endpointRouteBuilder.MapControllerRoute(name: "CustomerBillings",
       pattern: $"{lang}/Customer-Billings",
       defaults: new { controller = "Subscription", action = "AllBillings" });


        endpointRouteBuilder.MapControllerRoute(name: "CustomerReviews",
       pattern: $"{lang}/Customer-Reviews",
       defaults: new { controller = "Catalog", action = "MyReviews" });


        endpointRouteBuilder.MapControllerRoute(name: "CustomerMessages",
       pattern: $"{lang}/Customer-Messages",
       defaults: new { controller = "PrivateMessages", action = "Index" });
        ...
        endpointRouteBuilder.MapControllerRoute(name: "AddClaim",
        pattern: $"{lang}/Add-Claim",
        defaults: new { controller = "Claims", action = "Add" });
        
        
                endpointRouteBuilder.MapControllerRoute(name: "AddedClaim",
        pattern: $"{lang}/Addedd-Claim",
        defaults: new { controller = "Claims", action = "ClaimAdded" });



        endpointRouteBuilder.MapControllerRoute(name: "AdReport",
        pattern: $"{lang}/Report-ad",
        defaults: new { controller = "Claims", action = "AddReport" });



        endpointRouteBuilder.MapControllerRoute(name: "ReportAdded",
        pattern: $"{lang}/ReportAdded",
        defaults: new { controller = "Claims", action = "ReportAdded" });

        endpointRouteBuilder.MapControllerRoute(name: "VerifyEmail",
        pattern: $"{lang}/VerifyEmail",
        defaults: new { controller = "Customer", action = "VerifyEmail" });
