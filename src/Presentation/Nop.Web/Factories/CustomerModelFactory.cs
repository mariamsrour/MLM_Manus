...
public partial class CustomerModelFactory : ICustomerModelFactory
{
        ...
        bool excludeProperties, string overrideCustomCustomerAttributesXml = "")
    {
        ...
        if (!excludeProperties)
        {
            ...
            model.HideVisits = customer.HideVisits;
            model.ContactMe = customer.ContactMe;   
            model.SendEmails = customer.SendEmails;
        }
        else
        {
    ...
    public virtual async Task<CustomerNavigationModel> PrepareCustomerNavigationModelAsync(int selectedTabId = 0)
    {
        ...
        //    Title = await _localizationService.GetResourceAsync("Account.Wallet"),
        //    Tab = (int)CustomerNavigationEnum.Wallet,
        //    ItemClass = "reward-points"
        //});
        model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
        {
        ...
        {
            RouteName = "Wishlist",
            Title = await _localizationService.GetResourceAsync("Account.Wishlist"),
        ...
        model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
        {
            RouteName = "CustomerAds",
            Title = await _localizationService.GetResourceAsync("Account.MyAds"),
            Tab = (int)CustomerNavigationEnum.Ads,
            ItemClass = "customer-subscriptions"
        });
        ...
        model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
        {
            RouteName = "CustomerBillings",
            Title = await _localizationService.GetResourceAsync("Account.MyBillings"),
            Tab = (int)CustomerNavigationEnum.Billings,
            ItemClass = "customer-subscriptions"
        });

        model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
        {
            RouteName = "CustomerReviews",
            Title = await _localizationService.GetResourceAsync("Account.MyReviews"),
            Tab = (int)CustomerNavigationEnum.Reviews,
            ItemClass = "customer-subscriptions"
        });

        model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
        {
            RouteName = "CustomerMessages",
            Title = await _localizationService.GetResourceAsync("Account.MyMessages"),
            Tab = (int)CustomerNavigationEnum.Messages,
            ItemClass = "customer-subscriptions"
        });
        ...
        model.CustomerNavigationItems.Add(new CustomerNavigationItemModel
        {
            ...
            Title = await _localizationService.GetResourceAsync("Notifications"),
            Tab = (int)CustomerNavigationEnum.Notifications,
            ItemClass = "customer-subscriptions"
        });
    ...
    public virtual async Task<CustomerAvatarModel> PrepareCustomerAvatarModelAsync(int customerId)
    {
       // ArgumentNullException.ThrowIfNull(model);
