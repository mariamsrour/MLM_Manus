...
public partial interface IProductModelFactory
{
    ...
    Task<IList<PictureModel>> PrepareProductOverviewPicturesModelAsync(Product product, int? productThumbPictureSize = null);

    Task<List<ProductSpecificationAttributeModel>> PrepareProductSpecificationAttributeListAsync(int groupId);
