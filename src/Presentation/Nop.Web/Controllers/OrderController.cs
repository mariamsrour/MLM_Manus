...
public partial class OrderController : BasePublicController
{
    ...
    public async Task<IActionResult> CustomerWallet()
    {
        ...
        var balance = await _walletService.GetWalletBalanceAsync(customer.Id,currency.CurrencyCode);

        var model = new WalletViewModel
        {
            Balance = balance.ToString(),
            Transactions = (await _walletService.GetTransactionsAsync(customer.Id)).ToList()
        };
