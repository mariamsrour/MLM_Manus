...
public partial interface IHomeModelFactory
{
    ...
    Task<DataTablesModel> PrepareBestSellerCategoriesModelAsync(DataTablesModel model);


    Task<DataTablesModel> PrepareBestSellerVendorsModelAsync(DataTablesModel model);
