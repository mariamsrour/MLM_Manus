...
public partial class ReturnRequestModelFactory : IReturnRequestModelFactory
{
        ...
        ReturnRequest returnRequest, bool excludeProperties = false)
    {
        ...
        model.ReturnToVendorStatusStr = await _localizationService.GetLocalizedEnumAsync(returnRequest.ReturnToVendorStatus);
        ...
        model.ReturnToVendorStatusId = returnRequest.ReturnedToVendorStatusId;
        return model;
    }
