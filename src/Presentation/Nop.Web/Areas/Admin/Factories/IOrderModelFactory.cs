...
public partial interface IOrderModelFactory
{
    ...
    Task<VendorOrderReportListModel> BestSellingVendors(VendorOrderReportSearchModel searchModel);
    Task<CategoryOrderReportListModel> BestSellingCategories(CategoryOrderReportSearchModel searchModel);

    Task<CategoryOrderReportSearchModel> PrepareCategoryOrderReportSearchModelAsync(CategoryOrderReportSearchModel searchModel);

    Task<VendorOrderReportSearchModel> PrepareVendorOrderReportSearchModelAsync(VendorOrderReportSearchModel searchModel);
