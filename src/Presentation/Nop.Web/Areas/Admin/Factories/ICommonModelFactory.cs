...
public partial interface ICommonModelFactory
{
    ...
    /// <summary>
    /// Prepare Deliverystatistics model
    /// </summary>
    /// <returns>
    /// A task that represents the asynchronous operation
    /// The task result contains the delivery statistics model
    /// </returns>
    Task<DeliveryStatisticsModel> PrepareDeliveryStatisticsModelAsync(DeliveryStatisticsSearchModel searchModel);
    ...
    /// </returns>
    Task<BusinessStatisticsModel> PrepareBusinessStatisticsModelAsync(BusinessStatisticsSearchModel searchModel);
}