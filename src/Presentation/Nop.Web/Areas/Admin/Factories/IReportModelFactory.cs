...
public partial interface IReportModelFactory
{
    ...
    Task<CategoryOrderReportListModel> PrepareBestsellerCategoryListModelAsync(CategoryOrderReportSearchModel searchModel);
    Task<CategoryOrderReportSearchModel> PrepareBestsellerCategorySearchModelAsync(CategoryOrderReportSearchModel searchModel);


    Task<VendorOrderReportListModel> PrepareBestsellerVendorListModelAsync(VendorOrderReportSearchModel searchModel);
    Task<VendorOrderReportSearchModel> PrepareBestsellerVendorSearchModelAsync(VendorOrderReportSearchModel searchModel);

    Task<PeekHourReportListModel> PreparePeekHourListModelAsync(PeekHourReportSearchModel searchModel);
    Task<PeekHourReportSearchModel> PreparePeekHourSearchModelAsync(PeekHourReportSearchModel searchModel);

    Task<SalesItemsReportListModel> PrepareSalesItemsListModelAsync(SalesItemsReportSearchModel searchModel);
    Task<SalesItemsReportSearchModel> PrepareSalesItemsSearchModelAsync(SalesItemsReportSearchModel searchModel);

    Task<List<GenderStatisticsModel>> PrepareGenderCustomersReportListModelAsync(RegisteredCustomersReportSearchModel searchModel);
    Task<List<UsersStatisticsModel>> PrepareUsersinYearReportListModelAsync(RegisteredCustomersReportSearchModel searchModel);
    Task<List<UsersStatisticsModel>> PrepareUsersinMonthReporListModelAsync(RegisteredCustomersReportSearchModel searchModel);
    Task<EarningsReportModel> GetEarningsReportAsync(DateTime? startDate, DateTime? endDate);

    Task<ReturnedItemsPerVendorReportSearchModel> PrepareVendorReturnsSearchModelAsync(ReturnedItemsPerVendorReportSearchModel searchModel);
    Task<ReturnedItemsPerVendorReportList> PrepareVendorReturnsListModelAsync(ReturnedItemsPerVendorReportSearchModel searchModel);

    Task<ReturnTableCustomerListModel> PrepareReturnTableCustomerListModelAsync(ReturnTableCustomerSearchModel searchModel);
    Task<ReturnTableCustomerSearchModel> PrepareReturnTableCustomerSearchModelAsync(ReturnTableCustomerSearchModel searchModel);
    Task<ReturnTableVendorSearchModel> PrepareVendorReturnsTableSearchModelAsync(ReturnTableVendorSearchModel searchModel);
    Task<ReturnTableVendorListModel> PrepareReturnTableVendorListModelAsync(ReturnTableVendorSearchModel searchModel, bool isClaimed);
    Task<Models.Reports.ReturnKpiModel> GetRefundsKpisAsync(DateTime? startDate, DateTime? endDate);
