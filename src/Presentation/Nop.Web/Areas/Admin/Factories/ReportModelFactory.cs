...
using EarningsReportModel = Nop.Web.Areas.Admin.Models.Orders.EarningsReportModel;
...
public partial class ReportModelFactory : IReportModelFactory
{
        ...
        var model = await new BestsellerListModel().PrepareToGridAsync(searchModel, bestsellers, () =>
        {
            return bestsellers.SelectAwait(async bestseller =>
            {
                ...
                var bestsellerModel = new BestsellerModel
                {
                    ...
                    VendorName = bestseller.VendorName,
                    CategoryName = bestseller.CategoryName,
                };
    ...
    #region bestseller categories
    public virtual async Task<CategoryOrderReportListModel> PrepareBestsellerCategoryListModelAsync(CategoryOrderReportSearchModel searchModel)
    {
        ArgumentNullException.ThrowIfNull(searchModel);

        var bestsellers = await _orderReportService.GetBestSellingCategoriesAsync(searchModel.StartDate, searchModel.EndDate, searchModel.Page-1,searchModel.PageSize);

        //prepare list model
        var model = await new CategoryOrderReportListModel().PrepareToGridAsync(searchModel, bestsellers, () =>
        {
            return bestsellers.SelectAwait(async bestseller =>
            {
                //fill in model values from the entity
                var bestsellerModel = new CategoryOrderReportModel
                {
                   CategoryId = bestseller.CategoryId,
                   CategoryName = bestseller.CategoryName,
                    Rank = bestseller.Rank,
                    NumberOfOrders = bestseller.NumberOfOrders,
                };
    ...
    public virtual async Task<CategoryOrderReportSearchModel> PrepareBestsellerCategorySearchModelAsync(CategoryOrderReportSearchModel searchModel)
    {
        ArgumentNullException.ThrowIfNull(searchModel);
    ...
    public virtual async Task<VendorOrderReportListModel> PrepareBestsellerVendorListModelAsync(VendorOrderReportSearchModel searchModel)
    {
        ArgumentNullException.ThrowIfNull(searchModel);

        var bestsellers = await _orderReportService.GetBestSellingVendorsAsync(searchModel.StartDate, searchModel.EndDate, searchModel.Page - 1, searchModel.PageSize);

        //prepare list model
        var model = await new VendorOrderReportListModel().PrepareToGridAsync(searchModel, bestsellers, () =>
        {
            return bestsellers.SelectAwait(async bestseller =>
            {
                //fill in model values from the entity
                var bestsellerModel = new VendorOrderReportModel
                {
                    VendorId = bestseller.VendorId,
                    VendorName = bestseller.VendorName,
                    Rank = bestseller.Rank,
                    NumberOfOrders = bestseller.NumberOfOrders,
                };
    ...
    public virtual async Task<VendorOrderReportSearchModel> PrepareBestsellerVendorSearchModelAsync(VendorOrderReportSearchModel searchModel)
    {
        ArgumentNullException.ThrowIfNull(searchModel);
    ...
    public virtual async Task<PeekHourReportListModel> PreparePeekHourListModelAsync(PeekHourReportSearchModel searchModel)
    {
        ArgumentNullException.ThrowIfNull(searchModel);

        var bestsellers = await _orderReportService.GetPeekHoursAsync(searchModel.StartDate, searchModel.EndDate, searchModel.Page - 1, searchModel.PageSize);

        //prepare list model
        var model = await new PeekHourReportListModel().PrepareToGridAsync(searchModel, bestsellers, () =>
        {
            return bestsellers.SelectAwait(async bestseller =>
            {
                //fill in model values from the entity
                var bestsellerModel = new PeekHourReportModel
                {
                    CountryId = bestseller.CountryId,
                    CountryName = bestseller.CountryName,
                    Rank = bestseller.Rank,
                };
                var hours = bestseller.PeakHour.Select(x => x.ToString() + " : 00 ");
                bestsellerModel.PeakHour = string.Join(" , ", hours);
                bestsellerModel.NumberOfOrders = string.Join(" , ", bestseller.NumberOfOrders);
    ...
    public virtual async Task<PeekHourReportSearchModel> PreparePeekHourSearchModelAsync(PeekHourReportSearchModel searchModel)
    {
        ArgumentNullException.ThrowIfNull(searchModel);
    ...
    public virtual async Task<SalesItemsReportListModel> PrepareSalesItemsListModelAsync(SalesItemsReportSearchModel searchModel)

    {
        ArgumentNullException.ThrowIfNull(searchModel);

        var bestsellers = await _orderReportService.SalesItemsReportAsync(searchModel.StartDate, searchModel.EndDate, searchModel.Page - 1, searchModel.PageSize);

        //prepare list model
        var model = await new SalesItemsReportListModel().PrepareToGridAsync(searchModel, bestsellers, () =>
        {
            return bestsellers.SelectAwait(async bestseller =>
            {
                //fill in model values from the entity
                var bestsellerModel = new SalesItemsReportModel
                {
                  ProductName = bestseller.ProductName,
                  VendorName = bestseller.VendorName,
                  OrderId = bestseller.OrderId,
                  OrderDate = bestseller.OrderDate,
                    Rank = bestseller.Rank,
    ...
    public virtual async Task<SalesItemsReportSearchModel> PrepareSalesItemsSearchModelAsync(SalesItemsReportSearchModel searchModel)
    {
        ArgumentNullException.ThrowIfNull(searchModel);
    ...
    public virtual async Task<List<GenderStatisticsModel>> PrepareGenderCustomersReportListModelAsync(RegisteredCustomersReportSearchModel searchModel)
    {
        ArgumentNullException.ThrowIfNull(searchModel);

        var model = (await _customerReportService.GetGenderStatisticsAsync(searchModel.StartDate, searchModel.EndDate)).Select(x => new GenderStatisticsModel()
        {
            Count = x.Count,
            Gender = x.Gender
        }).ToList();
    ...
    public virtual async Task<List<UsersStatisticsModel>> PrepareUsersinYearReportListModelAsync(RegisteredCustomersReportSearchModel searchModel)
    {
        ArgumentNullException.ThrowIfNull(searchModel);
        var model = (await _customerReportService.GetPeriodUserStatisticsAsync(searchModel.StartDate, searchModel.EndDate, "month")).Select(x => new UsersStatisticsModel()
        {
            Count = x.Count,
            Month = x.Month,
            Year = x.Year
    ...
    public virtual async Task<List<UsersStatisticsModel>> PrepareUsersinMonthReporListModelAsync(RegisteredCustomersReportSearchModel searchModel)
    {
        ArgumentNullException.ThrowIfNull(searchModel);
        var model = (await _customerReportService.GetPeriodUserStatisticsAsync(searchModel.StartDate, searchModel.EndDate, "day")).Select(x => new UsersStatisticsModel()
        {
            Count = x.Count,
            Month = x.Month,
            Day = x.Day,
    ...
    public virtual async Task<EarningsReportModel> GetEarningsReportAsync(DateTime? startDate, DateTime? endDate)
    {
        var x = await _orderReportService.GetEarningsReportAsync(startDate, endDate);
        var model = new EarningsReportModel()
        {
            TotalOrders = x.TotalOrders,
            TotalOrderValue = x.TotalOrderValue,
            TotalOrderCost = x.TotalOrderCost,
            TotalProductsPrice = x.TotalProductsPrice,
            TotalProductsSold = x.TotalProductsSold,
            TotalShippingFees = x.TotalShippingFees,
            TotalTaxes = x.TotalTaxes,
            TotalCouponsUsed = x.TotalCouponsUsed,
            TotalCouponsValue = x.TotalCouponsValue,
            TotalReturnedProducts = x.TotalReturnedProducts,
            TotalReturnsValue = x.TotalReturnsValue
    ...
    public virtual async Task<ReturnedItemsPerVendorReportList> PrepareVendorReturnsListModelAsync(ReturnedItemsPerVendorReportSearchModel searchModel)

    {
        ArgumentNullException.ThrowIfNull(searchModel);

        var bestsellers = await _orderReportService.GetReturnedItemsPerVendorReportAsync(searchModel.StartDate, searchModel.EndDate,searchModel.VendorId, searchModel.Page - 1, searchModel.PageSize);

        //prepare list model
        var model = await new ReturnedItemsPerVendorReportList().PrepareToGridAsync(searchModel, bestsellers, () =>
        {
            return bestsellers.SelectAwait( async bestseller =>
            {
                //fill in model values from the entity
                var bestsellerModel = new ReturnedItemsPerVendorReportModel
                {
                   VendorId= bestseller.VendorId,
                   VendorName = bestseller.VendorName,
                   TotalReturnedItems = bestseller.TotalReturnedItems,
                   Rank = bestseller.Rank
                };
                //fill in additional values (not existing in the entity)
                bestsellerModel.TotalReturnedAmount = await _priceFormatter.FormatPriceAsync(bestseller.TotalReturnedAmount, true, false);
    ...
    public virtual async Task<ReturnedItemsPerVendorReportSearchModel> PrepareVendorReturnsSearchModelAsync(ReturnedItemsPerVendorReportSearchModel searchModel)
    {
        ArgumentNullException.ThrowIfNull(searchModel);
        await _baseAdminModelFactory.PrepareVendorsAsync(searchModel.AvailableVendors);
    ...
    public virtual async Task<ReturnTableCustomerListModel> PrepareReturnTableCustomerListModelAsync(ReturnTableCustomerSearchModel searchModel)

    {
        ArgumentNullException.ThrowIfNull(searchModel);

        var bestsellers = await _orderReportService.GetRefundedReturnsReportAsync(searchModel.StartDate, searchModel.EndDate, searchModel.Page - 1, searchModel.PageSize);

        //prepare list model
        var model = await new ReturnTableCustomerListModel().PrepareToGridAsync(searchModel, bestsellers, () =>
        {
            return bestsellers.SelectAwait(async bestseller =>
            {
                //fill in model values from the entity
                var bestsellerModel = new Models.Reports.ReturnTableCustomerModel
                {
                    RefundedStatus = bestseller.RefundedStatus,
                    RequestId = bestseller.RequestId,
                    ReturnedQuantity = bestseller.ReturnedQuantity,
                    CustomerName = bestseller.CustomerName,
                    DeliveryDate = bestseller.DeliveryDate,
                    OrderDate = bestseller.OrderDate,
                    OrderID = bestseller.OrderID,
    ...
    public virtual async Task<ReturnTableCustomerSearchModel> PrepareReturnTableCustomerSearchModelAsync(ReturnTableCustomerSearchModel searchModel)
    {
        ArgumentNullException.ThrowIfNull(searchModel);
    ...
    public virtual async Task<ReturnTableVendorSearchModel> PrepareVendorReturnsTableSearchModelAsync(ReturnTableVendorSearchModel searchModel)
    {
        ArgumentNullException.ThrowIfNull(searchModel);
    ...
    public virtual async Task<ReturnTableVendorListModel> PrepareReturnTableVendorListModelAsync(ReturnTableVendorSearchModel searchModel, bool isClaimed)

    {
        ArgumentNullException.ThrowIfNull(searchModel);

        var bestsellers = await _orderReportService.GetRefundedReturnsReportforVendorsAsync(searchModel.StartDate, searchModel.EndDate,isClaimed, searchModel.Page - 1, searchModel.PageSize);

        //prepare list model
        var model = await new ReturnTableVendorListModel().PrepareToGridAsync(searchModel, bestsellers, () =>
        {
            return bestsellers.SelectAwait(async bestseller =>
            {
                //fill in model values from the entity
                var bestsellerModel = new Models.Reports.ReturnTableVendorModel
                {
                    RefundedStatus = bestseller.RefundedStatus,
                    RequestId = bestseller.RequestId,
                    ReturnedQuantity = bestseller.ReturnedQuantity,
                    ...
                    OrderID = bestseller.OrderID,
                    Product = bestseller.Product,
                    ReturnDate = bestseller.ReturnDate,
                    VendorID = bestseller.VendorID,
                    VendorName = bestseller.VendorName                    

                };
                bestsellerModel.Amount = await _priceFormatter.FormatPriceAsync(bestseller.Amount, true, false);
    ...
    public virtual async Task<Models.Reports.ReturnKpiModel> GetRefundsKpisAsync(DateTime? startDate, DateTime? endDate)
    {
        var x = await _orderReportService.GetRefundedReturnsReportKPIsAsync(startDate, endDate);
        var model = new Models.Reports.ReturnKpiModel();
        model.TotalRefundedAmount = await _priceFormatter.FormatPriceAsync(x.TotalRefundedAmount, true, false);
        model.TotalRefundedOnWallet = await _priceFormatter.FormatPriceAsync(x.TotalRefundedOnWallet, true, false);
        model.TotalRefundedOnCard = await _priceFormatter.FormatPriceAsync(x.TotalRefundedOnCard, true, false);
        return model;
    }
