    ...
    IAclSupportedModel, IDiscountSupportedModel, ILocalizedModel<ProductLocalizedModel>, IStoreMappingSupportedModel
{
    ...
    public ProductModel()
    {
        RealStateLiscence = new RealStateLiscenceModel();
        ProductSpecsAttributes = new List<Nop.Web.Models.Catalog.ProductSpecificationAttributeModel>();
        ...
        AvailableAdStatus = new List<SelectListItem>();
    }
    ...
    public IList<Nop.Web.Models.Catalog.ProductSpecificationAttributeModel> ProductSpecsAttributes{ get; set; }
    ...
    public bool ShowOnMaps { get; set; }
    ...
    public RealStateLiscenceModel RealStateLiscence { get; set; }
    ...
    public IList<SelectListItem> AvailableAdStatus { get; set; }
