...
public partial class VendorController : BaseAdminController
{
    ...
    public virtual async Task<IActionResult> Edit(int id)
    {
        ...
        var customer = await _customerService.GetCustomerByVendorIdAsync(id);
        var products = await _vendorService.GetVendorProducts(id);
        var subscriptions = await _subscriptionService.GetAllSubscriptionAsync(customer.Id);
