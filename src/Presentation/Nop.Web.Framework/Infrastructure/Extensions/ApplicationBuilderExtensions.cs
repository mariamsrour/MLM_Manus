...
public static class ApplicationBuilderExtensions
{
    ...
    public static void UseNopRequestLocalization(this IApplicationBuilder application)
    {
        application.UseRequestLocalization(options =>
        {
            ...
            if(options.SupportedCultures.Any(c => c.Name == "ar-EG" || c.Name == "ar-SA")) 
                options.SupportedCultures.FirstOrDefault(c => c.Name == "ar-EG"|| c.Name == "ar-SA").DateTimeFormat.Calendar = new GregorianCalendar();
