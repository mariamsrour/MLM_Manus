...
public partial class NopStartup : INopStartup
{
    ...
    public virtual void ConfigureServices(IServiceCollection services, IConfiguration configuration)
    {
        ...
        services.AddScoped<ITempProductPictureService, TempProductPictureService>();
        services.AddScoped<ICategorySpecGroupService, CategorySpecGroupService>();
        services.AddScoped<IRealStateLiscenceService, RealStateLiscenceService>();
        ...
        services.AddScoped<INewsItemReadService, NewsItemReadService>();
